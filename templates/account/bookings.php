         ...
         <tr>
          ...
          <td>
           <?php if ($booking['status'] !== "completed") { ?>
            <a href="<?= DOC_ROOT ?>account/complete_booking/<?= html_escape($booking['id']) ?>" onclick="return confirm('complete the booking')"><i class="uil-clock"></i></a>
            <a href="<?= DOC_ROOT ?>account/cancel_booking/<?= html_escape($booking['id']) ?>" class="text-warning" onclick="return confirm('Are you sure you want to cancel this booking?')"><i class="uil-cancel"></i></a>
           <?php } ?>
           <a href="<?= DOC_ROOT ?>account/delete_booking/<?= html_escape($booking['id']) ?>" class="text-danger" onclick="return confirm('Are you sure you want to delete this item?')"><i class="mdi mdi-delete"></i></a>
          </td>
