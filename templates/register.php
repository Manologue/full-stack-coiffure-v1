...
<main id="register-page">
 <section class="section register-section">
  <div class="section-center">
   <h5>sinscrire comme coiffeur mobile</h5>
   <div class="register-center">
    ...
    <div class="short-description">
     <div class="text-container">
      ...
      <p>
       Not sure what you would do with DashStylists.com ? Take 5 min and check
       the
    ...
    <form method="POST" action="<?= DOC_ROOT ?>register" enctype="multipart/form-data">
     ...
     <div class="form-row">
      ...
      <input type="text" name="postal_code" value="<?= html_escape($user['postal_code'])  ?>" id="postal_code" class="form-input" />
     ...
     <button type="submit" name="register" class="btn btn-block">S'inscrire</button>
     <a class="login" href="<?= DOC_ROOT ?>login">
      Deja un compte? Click pour te connecter</a>
    </form>
   </div>
  </div>
 </section>
