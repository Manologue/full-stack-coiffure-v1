    ...
    forms.forEach((form) => {
      form.addEventListener('submit', async (e) => {
        ...
        infoAlertButton.addEventListener('click', async () => {
          const data = await fetch(`../../src/pages/admin/ajax/delete_category.php`, {
            method: 'POST',
            body: formData,
          })
  ...
  closeIcon.addEventListener('click', async () => {
    ...
    if (id !== '') {
      const data = await fetch(
        `../../../src/pages/admin/ajax/delete_image_category.php?delete=${id}`,
        {
          method: 'GET',
        }
      )
...
if (servicesPage) {
  ...
  const fetchAllServices = async () => {
    const data = await fetch(
      `../../../src/pages/admin/ajax/action_services.php?read=${category_id}`,
      {
        method: 'GET',
      }
    )
  ...
  addForm.addEventListener('submit', async (e) => {
    ...
    if (addForm.checkValidity() === false) {
      ...
      const data = await fetch('../../../src/pages/admin/ajax/action_services.php', {
        method: 'POST',
        body: formData,
      })
      const response = await data.text()
  ...
  const editUser = async (id) => {
    const data = await fetch(
      `../../../src/pages/admin/ajax/action_services.php?edit=${id}`,
      {
        method: 'GET',
      }
    )
  ...
  const deleteService = async (id) => {
    const data = await fetch(
      `../../../src/pages/admin/ajax/action_services.php?delete=${id}`,
      {
        method: 'GET',
      }
    )
...
if (usersPage) {
  ...
  usersPage.addEventListener('click', async (e) => {
    if (e.target && e.target.matches('a.edit-btn')) {
      ...
      const data = await fetch(`../../src/pages/admin/ajax/action_users.php?edit=${id}`, {
        method: 'GET',
      })
